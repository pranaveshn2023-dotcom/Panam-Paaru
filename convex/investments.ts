...
export function getIndianMarketStatus(): IndianMarketStatus {
  ...
  // AMC Daily NAV Release Window: 09:00 PM to 12:00 AM IST on regular trading weekdays
  // Weekends and official NSE/BSE holidays have NO NAV releases
